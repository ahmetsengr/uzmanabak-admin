<?php include 'inc/functions.php';
   $all_services = array_reverse(user_get_all());
?>
<!DOCTYPE html>
<html>
...
<head>
  ...
  <title>Uyeler - Uzmana Bak Yönetim</title>
  <!-- Favicon -->
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <!--<a href="kategori-ekle.php" class="btn btn-sm btn-neutral">Üye Ekle</a>-->
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Tüm Üyeler</h3>
            </div>
            <!-- Light table -->
            <div class="table-responsive">
              <table class="table align-items-center table-flush" id="uyeler">
                <thead class="thead-light">
                  <tr>
                    <th scope="col" class="sort" data-sort="budget">Üyeler</th>
         ...
         for ($i=0; $i < count( $all_services ); $i++) { 
           ...
           <th scope="row">
                      ...
                      <td>'; if($all_services[$i]['isActive'] == true){echo "Aktif";}else{echo "Pasif";} echo'</td>
                      <td class="text-right">
                      <a href="uyeler-duzenle.php?id='.$all_services[$i]['_id'].'" class="btn btn-sm btn-default">Düzenle</a>
