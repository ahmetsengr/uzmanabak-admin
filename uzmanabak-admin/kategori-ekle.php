...
<head>
  ...
  <title>kategori Ekle - UzmanaBak Yönetim</title>
  <!-- Favicon -->
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="#" class="btn btn-sm btn-neutral">kategori Ekle</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">kategori Ekle</h3>
            </div>
            <!-- Light table -->
            <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="file" name="img" class="form-control" id="input-email" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
