...
<head>
  ...
  <title>Uyeler - UzmanaBak Yönetim</title>
  <!-- Favicon -->
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Kurumsal Üyeler</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="index.php"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item active" aria-current="page">Kurumsal Üyeler</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-6 col-5 text-right">
               <!--<a href="kategori-ekle.php" class="btn btn-sm btn-neutral">Kurumsal Üye Ekle</a>-->
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Kurumsal Üyeler</h3>
            </div>
            <!-- Light table -->
            <div class="table-responsive">
              <table class="table align-items-center table-flush" id="kurumsaluyeler">
                <thead class="thead-light">
                  <tr>
                    <th scope="col" class="sort" data-sort="budget">Kurumsal Üyeler</th>
